...
**Purpose:** Active tasks only. Completed tasks are not retained here — git is the archive.
**When an item is DONE: delete it from this file.** Queues are for current work only.
...
- Completed tasks leave the file. Git log carries the history.
